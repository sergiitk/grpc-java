...
public class ManagedChannelImplBuilderTest {
  ...
  public void buildTransportFactory() {
    ...
    builder = new ManagedChannelImplBuilder(DUMMY_TARGET, mockClientTransportFactoryBuilder,
        new FixedPortProvider(DUMMY_PORT));
    assertEquals(mockClientTransportFactory, builder.buildTransportFactory());
